      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <button 
            ...
            className="bg-[#FBDCE2] text-foreground px-5 py-2 rounded-full font-bold text-sm hover:bg-primary/90 hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2 mx-auto mb-12"
          >
