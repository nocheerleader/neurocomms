      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <button 
            ...
            className="bg-[#FBDCE2] text-foreground px-5 py-2 rounded-full font-bold text-sm hover:bg--[#FBDCE2] hover:shadow-2xl transition-all duration-700 flex items-center justify-center gap-2 mx-auto mb-12"
          >
