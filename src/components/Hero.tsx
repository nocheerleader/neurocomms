        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-left">
            ...
            <p className="text-base text-muted-foreground mb-8 max-w-2xl leading-relaxed">
              For neurodiverse professionals who need to know: "Is my boss frustrated or just busy?" Get instant tone analysis and response suggestions for any workplace communication. Elucidare offers a set of tools to help neurodiverse professionals. 
            </p>
